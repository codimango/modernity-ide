...
def main() -> None:
    ...
    materials = {
        "flesh": material("#d2cec3", "#706e69", "#f5f1e8", "dither", 3),
        "flesh_light": material("#e5e0d5", "#918e87", "#fffdf5", "dither", 2),
        ...
        "organ_dark": material("#8d6567", "#3e2c30", "#c0938f", "dither", 3),
        "organ_light": material("#c1a09a", "#69504e", "#e6c7b9", "dither", 3),
        "intestine": material("#a87b77", "#493532", "#d4aaa0", "stripes", 3),
        "intestine_dark": material("#825a5c", "#342427", "#b88984", "dither", 2),
    }
    builder = SemanticModelBuilder()
    ...
    spec = {
        ...
        "generation": {
            ...
            "algorithm": "duplicate-aware-fused-zombie-anatomy-v2",
            "source_mesh": None,
