...
PAIRS = (
    (
        "Corrected Militech Chimera: six-leg reference",
        ROOT / "benchmarks" / "round2" / "references" / "chimera-alt.png",
        ROOT / "benchmarks" / "round2" / "cycles" / "02-militech-chimera" / "render" / "alternate-source-perspective.png",
        2,
    ),
    (
