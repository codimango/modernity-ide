...
def main() -> None:
    ...
    materials = {
        ...
        "bark_light": material("#a49277", "#4b4034", "#d7ccb3", "solid", 1),
        ...
        "gum": material("#71302d", "#281011", "#b8614f", "solid", 1),
        "flesh": material("#b5212d", "#4b1019", "#ed5860", "gradient", 3),
        "apple_red": material("#bd202a", "#5e1018", "#f05a5d", "solid", 1),
        "apple_dark": material("#75151e", "#2c0a0f", "#b82c38", "gradient", 3),
        "apple_light": material("#df3940", "#8a1520", "#ff8b82", "solid", 1),
        "tooth": material("#d7ccb0", "#726956", "#fff4d4", "gradient", 2),
        "root_tip": material("#8b795f", "#3d3329", "#cbbda0", "solid", 1),
