...
class RoundTwoAegisX2Tests(unittest.TestCase):
    ...
    def test_three_view_texture_transfer_is_direct_and_calibrated(self) -> None:
        """Gate direct source pixels from all three independent fixed cameras."""
        spec = json.loads((CYCLE / "model-spec.json").read_text(encoding="utf-8"))
        ...
        self.assertGreaterEqual(transfer["coverage"]["faces_with_source"], 380)
