...
- Reference-faithful output disables source palette quantization. Logos,
  seams, wear, and other flat identity marks come from the reference patch or
  an audited decal, not random dither or extra cuboids.
