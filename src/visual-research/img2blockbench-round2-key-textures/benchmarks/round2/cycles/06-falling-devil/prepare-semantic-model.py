...
def main() -> None:
    ...
    materials = {
        "skin": material("#dc937b", "#8d4c45", "#ffd0a8", "dither", 3),
        "skin_light": material("#efaa8e", "#a55f52", "#ffd8b8", "dither", 2),
        "skin_shadow": material("#b86e63", "#713b3b", "#eaa28a", "solid", 1),
        "white_cloth": material("#e4ded2", "#8f9292", "#fff8e9", "dither", 4),
        "white_shadow": material("#b8bab5", "#696e73", "#ebe6dc", "solid", 1),
        "black_cloth": material("#181a27", "#090a0f", "#383f70", "dither", 3),
        "black_shadow": material("#0d0f18", "#05060a", "#252a4c", "solid", 1),
        "blue_sheen": material("#283064", "#10142e", "#5663a8", "dither", 2),
