...
def main() -> None:
    ...
    add(box("saddle_core", "exo_pelvis", (0, 60.5, 1.5), (10, 5, 10),
    ...
    for side, sign in (("left", -1.0), ("right", 1.0)):
        ...
        restraint = add(box(f"pilot_{side}_boot_restraint", f"{side}_exo_ankle",
    ...
    spec = {
        ...
        "wearable": {
            ...
            "attachment_points": [
                ...
                {"name": "back_harness", "bone": "torso_frame", "position": [0, 72, -2]},
                {"name": "left_boot_stirrup", "bone": "left_exo_ankle", "position": [-16.5, 14, 2.5]},
                {"name": "right_boot_stirrup", "bone": "right_exo_ankle", "position": [16.5, 14, 2.5]},
                {"name": "left_hand_control", "bone": "torso_frame", "position": [-7, 66, 12]},
                {"name": "right_hand_control", "bone": "torso_frame", "position": [7, 66, 12]},
            ],
        },
        "generation": {
