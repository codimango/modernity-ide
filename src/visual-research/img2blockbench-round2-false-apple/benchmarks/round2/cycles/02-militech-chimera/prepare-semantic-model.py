...
def main() -> None:
    ...
    materials = {
        "armor": material("#62694d", "#30382e", "#929579", "dither", 5),
        "armor_light": material("#85866a", "#505440", "#b8b897", "dither", 4),
        "armor_dark": material("#3a4437", "#1b241e", "#66705b", "dither", 4),
        "edge": material("#252e2b", "#101615", "#515b55", "solid", 1),
        "joint": material("#293437", "#11191b", "#657176", "dither", 3),
        ...
        "rubber": material("#262a27", "#0f1210", "#505651", "dither", 4),
    }
