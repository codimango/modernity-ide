...
def ellipsoid_cuboids(
    ...
    *,
    ...
    """Voxelize a superellipsoid and greedily merge its exact occupied cells.
    ...
    orthographic profiles and exact voxel occupancy.
    """
    origin = _point(center, "center")
    ...
    return EllipsoidResult(tuple(cubes), shape, occupied_count, cell_size)
