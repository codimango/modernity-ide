    ...
    proportions.update(
        {
            ...
            "arms_depth_to_width": round(proportions["arms_xyz_extents"][2] / proportions["arms_xyz_extents"][0], 6),
        }
    )
    report = {
        "schema_version": 1,
        ...
        "depth_gates": {
            "torso_depth_to_width_at_least_0.70": proportions["torso_depth_to_width"] >= 0.70,
            "head_depth_to_width_at_least_0.80": proportions["head_depth_to_width"] >= 0.80,
            "brain_depth_to_width_at_least_1.10": proportions["brain_depth_to_width"] >= 1.10,
            "arms_depth_to_width_at_least_0.33": proportions["arms_depth_to_width"] >= 0.33,
        },
