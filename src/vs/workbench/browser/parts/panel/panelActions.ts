...
// Modernity: IsAuxiliaryWindowContext no longer used after hiding Toggle Panel from top bar
...
// Modernity: panelIcon no longer used after hiding Toggle Panel from top bar
// Modernity: panelOffIcon no longer used after hiding Toggle Panel from top bar
...
// Modernity: hide LayoutControlMenu items for simple agent panel experience - remove Toggle Panel from top bar
