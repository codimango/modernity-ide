...
// Modernity: ChatStatusBarEntry no longer used after hiding Copilot icon from status bar
...
import { ModernityEpisodeSessionContribution } from './modernityEpisodeSession.js';
...
// Modernity: hide Copilot icon button from bottom right status bar for simple agent panel experience
...
registerWorkbenchContribution2(ModernityEpisodeSessionContribution.ID, ModernityEpisodeSessionContribution, WorkbenchPhase.AfterRestored);
